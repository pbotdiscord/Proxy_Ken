    ...
    if (var.get(0).m_key == "action" && var.get(0).m_value == "input") {
        ...
        //deleted for private reasons ;)
            ...
            paket =
                ...
                "\nadd_textbox|`4IMPORTANT: `oDiscord: Kenzie#1636.|left|2480|"
                "\nadd_quick_exit|"
                "\nend_dialog|end|Cancel|Okay|";
            variantlist_t liste{ "OnDialogRequest" };
            liste[1] = paket;
        ...
        else if (find_command(chat, "emp")) {
            std::string paket;
            paket =
                "\nadd_label_with_icon|big|Proxy Commands|left|32|"
                "\nadd_spacer|small"
                "\nadd_textbox|`9/emp `#(shows commands)|left|2480|"
...
std::string paket = "add_label_with_icon|big|`5Emperor Gazette``|left|5016|"
//"\nadd_image_button|banner|interface/large/wtr_lvl11_xualqu.rttex|bannerlayout|||"
"\nadd_spacer|small|\n\nadd_url_button||`1Join Discord Server``|NOFLAGS|https://discord.gg/QWCEdXgSnc|Open link?|0|0|"
"\nadd_textbox|`wMay 15th: `5Don't Forget Join Discord Server https://discord.gg/QWCEdXgSnc |left|"
"\nadd_spacer|small|"
"\nadd_textbox|`wMay 15th: `5Proxy made by Kenzie#1636 |left|"
"\nadd_spacer|small|"
...
"\nadd_textbox|`9/world `#(shows commands)|left|2480|"
"\nadd_textbox|`9/bypassvault `#(Bypassing Safe Vault)|left|2480|"
"\nadd_textbox|`9/bypassdoor `#(Bypassing the Door ID /setid (set door id))|left|2480|"
"\nadd_textbox|`9/bypasspath `#(Bypassing the Path Marker)|left|2480|"
"\nadd_textbox|`9/tp [name] `#(teleports to a player in the world) |left|2480|"
"\nadd_textbox|`9/ghost `#(toggles ghost, you wont move for others when its enabled)|left|2480|"
"\nadd_textbox|`9/uid [name] `#(resolves name to uid)|left|2480|"
...
"\nadd_textbox|Don't forget to join our `2Official Proxy Discord Server`` on `2https://discord.gg/QWCEdXgSnc `` or click the link below!|left|"
...
"\nadd_image_button|iotm_layout_4|interface/large/gazette/gazette_5columns_social_btn06.rttex|5imageslayout|https://discord.gg/QWCEdXgSnc|Would you like to join our "
"discord?|"
"\nadd_layout_spacer|2imageslayout|"
"\nadd_textbox||\nadd_spacer|small|"
"\nadd_textbox||\nadd_spacer|small|"
